/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 86d77d65ea805463bfadcad0f7726bc8)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	DEV_BYPASS_ACCESS: "false";
	ACCESS_ALLOWED_EMAIL: "anqilacat@outlook.com";
	ME_SESSION: DurableObjectNamespace<import("./index").MeSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "MeSession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEV_BYPASS_ACCESS" | "ACCESS_ALLOWED_EMAIL">> {}
}
